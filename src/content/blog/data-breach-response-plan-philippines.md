...
1. **Preparation** (before a breach happens)
2. **Detection & Containment** (0-4 hours)
3. **Assessment & Notification** (4-72 hours)
4. **Recovery & Lessons Learned** (post-breach)
...
2. **Alert the Incident Commander and DPO immediately**
3. **Document everything** - Start a breach log with timestamps
...
>
> **What Happened:**
> On [Date], we discovered that an unauthorized party gained access to our customer database between [Date] and [Date].
>
> **What Information Was Involved:**
> The compromised data includes names, email addresses, and phone numbers. Your payment information was NOT affected as we do not store credit card details.
>
> **What We're Doing:**
> We have immediately secured our systems, engaged cybersecurity experts to investigate, and reported this incident to the National Privacy Commission. We are implementing additional security measures to prevent future incidents.
>
> **What You Should Do:**
...
1. **Complete forensic investigation** - Hire external experts if needed
2. **Implement fixes** - Patch vulnerabilities, strengthen security
3. **Monitor for further incidents** - Heightened vigilance period
4. **Respond to NPC requests** - Provide additional information as requested

**Short-Term Actions (Month 1-3):**
5. **Conduct post-incident review** - What went wrong? What went right?
6. **Update security measures** - Address identified weaknesses
7. **Retrain staff** - Security awareness, breach response procedures
8. **Review third-party contracts** - Ensure vendors meet security standards

**Long-Term Prevention (Ongoing):**
9. **Update breach response plan** - Incorporate lessons learned
10. **Regular security audits** - Quarterly or annual reviews
...
- **NPC Reporting:** Required within 72 hours
- **Customer Notification:** Recommended as soon as confirmed (legal maximum: 72 hours)
